/**
 * @file usbd_desc.c
 * @brief USB device descriptors for CDC Virtual COM Port (FS).
 *
 * BlackPill F411 port: uses STMicroelectronics VID/PID for CDC.
 */
...
#define USBD_VID                    0x0483U  /* STMicroelectronics VID */
#define USBD_PID_FS                 0x5740U  /* STM32 Virtual COM Port PID */
#define USBD_LANGID_STRING          0x0409U  /* English (US) */
#define USBD_MANUFACTURER_STRING    "STMicroelectronics"
#define USBD_PRODUCT_STRING_FS      "BlackPill F411 Virtual ComPort"
