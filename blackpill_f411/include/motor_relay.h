 ...
 *
 * BlackPill F411 port:
 * Relay 1 (PB0): Motor+ polarity
 * Relay 2 (PB1): Motor- polarity
...
/* GPIO pin assignments — PB0 and PB1 on BlackPill header */
#define MOTOR_RELAY1_PORT   GPIOB
#define MOTOR_RELAY1_PIN    GPIO_PIN_0
#define MOTOR_RELAY2_PORT   GPIOB
#define MOTOR_RELAY2_PIN    GPIO_PIN_1
