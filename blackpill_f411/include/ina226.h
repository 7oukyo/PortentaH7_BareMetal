 ...
 *
 * BlackPill F411 port: I2C1 (PB6=SCL, PB7=SDA).
 * 7-bit address 0x40 (A0=GND, A1=GND).
 * Shunt resistor: configurable via INA226_SHUNT_OHM (10 mohm physical).
 */
...
#define INA226_REG_SHUNT_V      0x01U   /* Shunt voltage (1.0 uV/bit on clone, signed) */
...
/** Initialize I2C1 and configure INA226. Returns false on comm failure. */
